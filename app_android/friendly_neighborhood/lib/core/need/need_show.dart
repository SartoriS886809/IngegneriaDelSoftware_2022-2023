...
class _ShowNeedState extends State<ShowNeed> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ListTile(title: Text("Autore"),subtitle:Text(widget.need.creator)),
              //Text('Creato da: ${widget.need.creator}'),
            ListTile(title: Text("Data pubblicazione"),subtitle:Text("${widget.need.postDate.day}-${widget.need.postDate.month}-${widget.need.postDate.year}")), 
              //Text('Pubblicato il: ${widget.need.postDate.day}-${widget.need.postDate.month}-${widget.need.postDate.year}'),
            ListTile(title: Text("Luogo"),subtitle:Text(widget.need.address)),
              //Text('Luogo associato: ${widget.need.address}'),
            if (widget.isItMine && widget.need.assistant != "")
              ListTile(title: Text("Assistente volontario"),subtitle:Text(widget.need.assistant)),  
                //Text('Richiesta presa in carico da: ${widget.need.assistant}'),
            if (widget.isItMine && widget.need.assistant == "")
                const ListTile(title: Text("Autore"),subtitle:Text("La richiesta non è ancora stata presa in carico")),
                //const Text('La richiesta non è ancora stata presa in carico'),
            ListTile(title: Text("Descrizione"),subtitle:Text(widget.need.description), ),  
