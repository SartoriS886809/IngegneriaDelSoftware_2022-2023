...
INSERT INTO users VALUES ('email1@email.com', crypt('passpass', gen_salt('bf', 8)), 'username1', 'name1', 'lastname1', '2000-06-17', 'address1', 4, 'house type', 'token1', 1);
INSERT INTO users VALUES ('email2@email.com', crypt('passpass', gen_salt('bf', 8)), 'username2', 'name2', 'lastname2', '2000-06-17', 'address2', 4, 'house type', 'token2', 1);
INSERT INTO users VALUES ('email3@email.com', crypt('passpass', gen_salt('bf', 8)), 'username3', 'name3', 'lastname3', '2000-06-17', 'address3', 4, 'house type', 'token3', 2);
